...
const VGROUP_LIST = require('./vgroup-def')
const GROUP_TYPE = require('../def/group-type')
const kfExtension = require('../kf-ext/extension')

var KFParser = kf.Parser,
    CURSOR_CHAR = sysconf.cursorCharacter,
    ROOT_P_TEXT = sysconf.rootPlaceholder.content,
