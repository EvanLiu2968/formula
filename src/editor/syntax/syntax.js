...
const MoveComponent = require('./move')
const DeleteComponent = require('./delete')
const sysconf = require('../sysconf')
const GROUP_TYPE = require('../def/group-type')


var CURSOR_CHAR = sysconf.cursorCharacter;

var SyntaxComponenet = kity.createClass( 'SyntaxComponenet', {
...
module.exports = SyntaxComponenet;
