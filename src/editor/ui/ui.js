...
const $$ = require('./ui-impl/ui-utils')
const Utils = require('../base/utils')
const def = require('./def')
const Scrollbar = require('./ui-impl/scrollbar/scrollbar')
const Toolbar = require('./toolbar/toolbar')
// 控制组件
const ScrollZoom = require('./control/zoom')
const ELEMENT_LIST = require('./toolbar-ele-list')

var VIEW_STATE = def.VIEW_STATE;

var UIComponent = kity.createClass( 'UIComponent', {
