 ...
 */
const { kity, kf } = require('../global')
const component = require('../base/component')


const Assembly = kf.Assembly;
...
const RenderComponenet = kity.createClass('RenderComponent', {
    ...
    render: function ( latexStr ) {
        ...
        var pureLatexStr = latexStr.replace('\uF155', "" )

        console.log('latexStr:', pureLatexStr)
        console.log('parsedTree:', parsedTree)
        console.log('objTree:', objTree)

        this.kfEditor.Events.emit('latexChange', pureLatexStr)
        // 更新语法模块所维护的树
...
module.exports = RenderComponenet
